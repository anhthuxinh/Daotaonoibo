...
grant execute on function public.submit_poll_vote(text, text, text) to anon, authenticated, service_role;
grant execute on function public.get_poll_results(text) to anon, authenticated, service_role;
